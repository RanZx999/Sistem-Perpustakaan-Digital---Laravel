...
<div class="container mx-auto px-4 py-12 max-w-3xl">
    ...
    <div class="mb-8">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-4xl font-bold text-gray-800 mb-2">Tambah Buku Baru</h1>
                <p class="text-gray-600">Lengkapi form di bawah untuk menambahkan buku</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
        ...
        <!-- Form Content -->
        <form action="/buku/store" method="post" class="p-8 space-y-6">
            @csrf
            ...
            <div>
                ...
                <input 
                    ...
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 outline-none @error('kode_buku') border-red-500 @enderror"
                    value="{{ old('kode_buku') }}"
                >
                @error('kode_buku')
            ...
            <div>
                ...
                <input 
                    ...
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 outline-none @error('judul') border-red-500 @enderror"
                    value="{{ old('judul') }}"
                >
                @error('judul')
                <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
            ...
            <div>
                ...
                >
                    ...
                    <option value="{{ $pen->id_penulis }}">{{ $pen->nama_penulis }}</option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                >
                    ...
                    <option value="{{ $pnb->id_penerbit }}">{{ $pnb->nama_penerbit }}</option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                <input 
                    ...
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 outline-none @error('stok') border-red-500 @enderror"
                    value="{{ old('stok', 0) }}"
                >
                @error('stok')
                <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
