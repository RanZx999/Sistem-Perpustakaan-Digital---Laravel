...
<div class="container mx-auto px-4 py-12 max-w-3xl">
    ...
    <div class="mb-8">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-4xl font-bold text-gray-800 mb-2">Edit Data Petugas</h1>
                <p class="text-gray-600">Perbarui informasi data petugas</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
        ...
        <!-- Form Content -->
        <form action="/petugas/update" method="post" class="p-8 space-y-6">
            @csrf
            ...
            <div class="bg-gradient-to-r from-amber-50 to-orange-50 border-l-4 border-amber-500 p-4 rounded-r-lg">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-700">Sedang mengedit data petugas:</p>
                        <p class="text-lg font-bold text-gray-900">{{ $p->nama_petugas }}</p>
                    </div>
                </div>
            </div>
